  ...
  <body data-spy="scroll" data-target="#navbar1" data-offset="60">
                    ...
                    <div class="text-center m-0 vh-100 d-flex flex-column justify-content-center text-light">
                        ...
                        <div class="mt-2 mx-auto">
                                  ...
                                  <div class="dropdown-menu">
                                      ...
                                      <div class="dropdown-divider"></div>
                                      <a class="dropdown-item" target="new" href="https://github.com/ThemesGuide/bootstrap-themes/tree/master/fresca">Full template</a>
                                  </div>
                                </div> 
                        </div>
                    </div>
    ...
    <main>
        <section class="container">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-9">
                        <div class="pb-3">
                            <button type="button" class="btn btn-primary mr-1">Primary #07689F</button>
        ...
        <section id="typography" class="container pb-5">
            <div class="row">
                <div class="col-12">
                    <h4><a target="_new" href="https://fonts.google.com/specimen/Muli">Muli</a></h4>
                </div>
                <div class="col-xl-4">
                    <h6>Heading 6</h6>
                    <h5>Heading 5</h5>
